...
public class TreatmentController {
	...
	@RequestMapping(value = "/getAllTreatment", produces = org.springframework.http.MediaType.APPLICATION_JSON_VALUE)
	@ResponseBody
	...
	@ResponseBody
	public Object getAllTreatmentByAppID(@PathVariable Integer appID) {
	...
	@ResponseBody
	public Object getTreatmentByID(@PathVariable Integer id) {
