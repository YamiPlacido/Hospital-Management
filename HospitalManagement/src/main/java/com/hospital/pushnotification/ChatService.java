...
package com.hospital.pushnotification;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hospital.dto.Message;
...
public class ChatService {
	...
	public Message onMessage(Message message) throws IOException {
		this.logger.info("Author {} sent message {} to {}", message.getSender(),
				message.getMessage(),message.getReceiver());
		return message;
	}
